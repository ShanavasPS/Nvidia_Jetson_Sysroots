...
SYSROOT_ARCHIVE_FILE=sysroot-nvidia_jetson_nano_ubuntu_18.04.6_aarch64.tar.xz

# Nvidia defines
SOC_NAME=t210
NVIDIA_DOWNLOAD_LOCATION=https://developer.nvidia.com/embedded/l4t/r32_release_v7.1/$SOC_NAME
L4T_DRIVER_PACKAGE=jetson-210_linux_r32.7.1_aarch64.tbz2
